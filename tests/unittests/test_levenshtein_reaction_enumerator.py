...
from smiles_augmentation.reaction_smiles_enumerator import LevenshteinReactionSmilesEnumerator


class TestLevenshteinReactionSmilesEnumerator(TestCase):
    ...
    def test_reaction_smiles_enumerator(self):
        ...
        enumerator0 = LevenshteinReactionSmilesEnumerator(reaction_smiles0,
        ...
        enumerator1 = LevenshteinReactionSmilesEnumerator(reaction_smiles1,
                                                          remove_duplicates=False,
                                                          seed=None,
                                                          n_jobs=1,
                                                          verbose=0)
        ...
        enumerator2 = LevenshteinReactionSmilesEnumerator(reaction_smiles2,
                                                          remove_duplicates=False,
                                                          seed=123,
                                                          n_jobs=1,
                                                          verbose=0)
        ...
        enumerator3 = LevenshteinReactionSmilesEnumerator(reaction_smiles_list,
