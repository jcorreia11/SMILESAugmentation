...
class TestPermutationsReactionSmilesEnumerator(TestCase):
    ...
    def test_reaction_smiles_enumerator(self):
        ...
        enumerator0 = PermutationsReactionSmilesEnumerator(reaction_smiles0,
        ...
        enumerator1 = PermutationsReactionSmilesEnumerator(reaction_smiles1,
                                                           remove_duplicates=False,
                                                           seed=None,
                                                           n_jobs=1,
                                                           verbose=0)
        ...
        enumerator2 = PermutationsReactionSmilesEnumerator(reaction_smiles2,
                                                           remove_duplicates=False,
                                                           seed=123,
                                                           n_jobs=1,
                                                           verbose=0)
        ...
        enumerator3 = PermutationsReactionSmilesEnumerator(reaction_smiles_list,
